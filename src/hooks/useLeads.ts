...
export const useLeads = (organizationId?: string) => {
  ...
  console.log('[useLeads] Initializing with organizationId:', orgId);
  console.log('[useLeads] currentUser:', currentUser ? { id: currentUser.id, organizationId: currentUser.organizationId } : 'null');
  ...
  console.log('[useLeads] Cases received:', cases.length, 'loading:', loading, 'error:', error);
  ...
  console.log('[useLeads] Mapped leads:', leads.length);

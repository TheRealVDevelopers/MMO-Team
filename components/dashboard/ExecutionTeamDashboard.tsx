...
import ProjectCard from './execution-team/ProjectCard';
import ProjectDetailPane from './execution-team/ProjectDetailPane';
  ...
  return (
    <div className="flex h-full bg-subtle-background">
      <div className="flex-1 flex flex-col p-4 sm:p-6 lg:p-8">
        <h2 className="text-2xl font-bold text-text-primary mb-6">Execution Team Dashboard</h2>

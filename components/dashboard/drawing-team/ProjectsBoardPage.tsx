...
import { ClockIcon, FireIcon, PaperClipIcon } from '../../icons/IconComponents';
...
const ProjectsBoardPage: React.FC<{ onProjectSelect: (project: Project) => void }> = ({ onProjectSelect }) => {

...
const QuotationDetailModal: React.FC<{
    ...
    const [selectedItems, setSelectedItems] = useState<(Item & { remarks?: string })[]>([]);
                    ...
                    <div className="border-r border-border pr-6">
                        ...
                        <div className="space-y-2 max-h-64 overflow-y-auto pr-2">
                            {selectedItems.map((item, index) => (
                                <div key={`${item.id}-${index}`} className="bg-subtle-background p-3 rounded-md text-sm space-y-1">
                                    ...
                                    <input
                                        ...
                                        className="w-full text-xs p-1 bg-white border border-border rounded"
                                    />
                                </div>
                            ))}
                        </div>

        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 md:p-8">
                <motion.div
                    ...
                    className="bg-surface w-full max-w-6xl h-full max-h-[90vh] rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col border border-border/40"
                >
                    {/* Header */}
                    <div className="px-8 py-6 border-b border-border/60 flex justify-between items-center bg-subtle-background/30">
                        <div>
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary mb-1 block">Execution Protocol Review</span>
                            <h2 className="text-3xl font-serif font-black text-text-primary tracking-tight">
                                {request.title}
                            </h2>
                        </div>
                        <button
                            onClick={onClose}
                            className="p-3 rounded-2xl bg-surface border border-border hover:bg-subtle-background transition-all group"
                        >
                            <XMarkIcon className="w-6 h-6 text-text-tertiary group-hover:text-text-primary" />
                        </button>
                    </div>
                    ...
                    {/* Footer Actions */}
                    <div className="px-8 py-8 border-t border-border/60 bg-surface flex flex-col md:flex-row justify-between items-center gap-6">

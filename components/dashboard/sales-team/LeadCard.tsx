...
const statusConfig: Record<LeadPipelineStatus, { color: string, progress: number, nextAction: string }> = {
    ...
    [LeadPipelineStatus.SITE_VISIT_RESCHEDULED]: { color: 'bg-orange-500', progress: 40, nextAction: 'Reschedule Visit' },
    [LeadPipelineStatus.WAITING_FOR_DRAWING]: { color: 'bg-slate-500', progress: 50, nextAction: 'Await Drawing' },
    [LeadPipelineStatus.DRAWING_IN_PROGRESS]: { color: 'bg-blue-500', progress: 55, nextAction: 'Refining Design' },
    [LeadPipelineStatus.DRAWING_REVISIONS]: { color: 'bg-indigo-500', progress: 60, nextAction: 'Review Revision' },
    [LeadPipelineStatus.WAITING_FOR_QUOTATION]: { color: 'bg-teal-500', progress: 65, nextAction: 'Await Estimation' },
    [LeadPipelineStatus.QUOTATION_SENT]: { color: 'bg-primary', progress: 75, nextAction: 'Follow Up on Quote' },
    [LeadPipelineStatus.NEGOTIATION]: { color: 'bg-accent', progress: 85, nextAction: 'Finalize Deal' },
    [LeadPipelineStatus.IN_SOURCING]: { color: 'bg-purple-500', progress: 90, nextAction: 'Monitor Sourcing' },

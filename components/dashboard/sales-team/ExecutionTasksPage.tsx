    ...
    return (
        ...
        >
            <ContentCard
                ...
                subtitle="Monitor the progress of project execution tasks"
                        ...
                        <tbody className="divide-y divide-border/40 bg-transparent">
                            {myRequests.map((req, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <ExecutionStatusPill status={req.status} />
                                    </td>
                                </motion.tr>
                            ))}
                            {myRequests.length === 0 && (
                                <tr>
                                    <td colSpan={4} className="text-center py-12">
                                        <div className="flex flex-col items-center gap-2 text-text-tertiary">
                                            ...
                                            <p className="text-sm font-medium">No execution tasks found</p>
                                        </div>
                                    </td>
                                </tr>
                            )}

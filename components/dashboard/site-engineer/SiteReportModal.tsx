    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const report: SiteReport = {
                ...
                measurements,
                photos, // Storing Base64 strings directly in the array
                notes,
            };
            ...
            <div className="flex justify-between items-center mt-6 pt-4 border-t border-border">
                ...
                {step < 4 ? (
                    ...
                    <button
                        ...
                        className="px-4 py-2 text-sm font-medium text-white bg-secondary rounded-md hover:opacity-90 disabled:opacity-50"
                    >

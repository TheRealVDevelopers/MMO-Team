        ...
        return (
            <Modal isOpen={isOpen} onClose={onClose} title="" size="2xl">
                <div className="text-center py-12">
                    ...
                    <h3 className="text-2xl font-bold text-kurchi-espresso-900 mb-4">{successMessage}</h3>
                </div>
            </Modal>
        );
    }
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Enquiry Details" size="4xl">
            <div className="space-y-6">
                {/* Enquiry Info */}
                <div className="bg-gradient-to-r from-kurchi-gold-500/10 to-kurchi-espresso-900/10 rounded-xl p-6">
                    <div className="grid grid-cols-2 gap-6">
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Enquiry ID</p>
                            <p className="text-lg font-mono font-bold text-kurchi-gold-600">{enquiry.enquiryId}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Status</p>
                            <p className="text-lg font-bold text-kurchi-espresso-900">{enquiry.status}</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Client Details */}
                <div>
                    <h3 className="font-bold text-lg mb-4 text-kurchi-espresso-900">Client Information</h3>
                    <div className="grid grid-cols-2 gap-6 bg-gray-50 rounded-xl p-6">
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Name</p>
                            <p className="font-bold text-kurchi-espresso-900">{enquiry.clientName}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Email</p>
                            <p className="font-bold text-kurchi-espresso-900">{enquiry.email}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Mobile</p>
                            <p className="font-bold text-kurchi-espresso-900">{enquiry.mobile}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-500 mb-1">City</p>
                            <p className="font-bold text-kurchi-espresso-900">{enquiry.city}</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Project Details */}
                <div>
                    <h3 className="font-bold text-lg mb-4 text-kurchi-espresso-900">Project Details</h3>
                    <div className="grid grid-cols-2 gap-6 bg-gray-50 rounded-xl p-6">
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Project Type</p>
                            <p className="font-bold text-kurchi-espresso-900">{enquiry.projectType}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Space Type</p>
                            <p className="font-bold text-kurchi-espresso-900">{enquiry.spaceType}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Area</p>
                            <p className="font-bold text-kurchi-espresso-900">{enquiry.area}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Budget Range</p>
                            <p className="font-bold text-kurchi-espresso-900">{enquiry.budgetRange}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Design Style</p>
                            <p className="font-bold text-kurchi-espresso-900">{enquiry.designStyle}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Timeline</p>
                            <p className="font-bold text-kurchi-espresso-900">{enquiry.completionTimeline}</p>
                        </div>
                    </div>
                </div>
                ...
                {enquiry.additionalNotes && (
                    <div>
                        <h3 className="font-bold text-lg mb-4 text-kurchi-espresso-900">Additional Notes</h3>
                        <div className="bg-gray-50 rounded-xl p-6">
                            <p className="text-kurchi-espresso-900">{enquiry.additionalNotes}</p>
                        </div>
                    </div>
                )}
                ...
                {enquiry.status === EnquiryStatus.NEW && (
                    <div className="border-t-2 border-gray-200 pt-6">
                        <h3 className="font-bold text-lg mb-4 text-kurchi-espresso-900 flex items-center space-x-2">
                            <UserPlusIcon className="w-6 h-6 text-kurchi-gold-500" />
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full p-3 border-2 border-gray-300 rounded-lg focus:border-kurchi-gold-500 outline-none"
                                >
                            ...
                            <button
                                ...
                                className="w-full py-4 bg-kurchi-espresso-900 text-white font-bold rounded-xl hover:bg-kurchi-gold-500 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                            >
                                {isAssigning ? (
                                    <>

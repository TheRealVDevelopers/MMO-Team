    ...
    <header className="bg-white dark:bg-surface border-b border-border/60 dark:border-border sticky top-0 z-20 flex-shrink-0 shadow-sm">
      <div className="flex items-center justify-between h-16 md:h-18 px-4 md:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-3">
             ...
             <div className="flex items-center space-x-3">
                ...
                <div className="hidden sm:block">
                    <h1 className="text-lg font-bold text-kurchi-espresso-900 dark:text-white tracking-tight">
                        Kurchi
                    </h1>
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
             ...
             <button
                onClick={toggleTheme}
                className="p-2.5 rounded-xl text-text-secondary dark:text-text-primary hover:bg-subtle-background dark:hover:bg-background hover:text-kurchi-gold-600 focus:outline-none focus:ring-2 focus:ring-kurchi-gold-500/20 transition-all"
             ...
             <div className="relative hidden sm:block">
                <button
                    ...
                    className="relative p-2.5 rounded-xl text-text-secondary dark:text-text-primary hover:bg-subtle-background dark:hover:bg-background hover:text-kurchi-gold-600 focus:outline-none focus:ring-2 focus:ring-kurchi-gold-500/20 transition-all"
                ...
                {showNotifications && (
                    <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-surface rounded-xl shadow-luxury border border-border dark:border-border overflow-hidden z-30">
                        <div className="px-4 py-3 border-b border-border dark:border-border bg-subtle-background dark:bg-background">
                            <h3 className="text-sm font-bold text-kurchi-espresso-900 dark:text-white">Notifications</h3>
                        </div>
                        <div className="max-h-96 overflow-y-auto">
                            <div className="p-4 hover:bg-subtle-background dark:hover:bg-background cursor-pointer transition-colors border-b border-border dark:border-border">
                                <p className="text-sm font-medium text-kurchi-espresso-900 dark:text-white mb-1">New lead assigned</p>
                                <p className="text-xs text-text-secondary">5 minutes ago</p>
                            </div>
                            <div className="p-4 hover:bg-subtle-background dark:hover:bg-background cursor-pointer transition-colors border-b border-border dark:border-border">
                                <p className="text-sm font-medium text-kurchi-espresso-900 dark:text-white mb-1">Quotation approved</p>
                            ...
                            <div className="p-4 hover:bg-subtle-background dark:hover:bg-background cursor-pointer transition-colors">
                                <p className="text-sm font-medium text-kurchi-espresso-900 dark:text-white mb-1">Site visit scheduled</p>
                        ...
                        <div className="px-4 py-3 border-t border-border dark:border-border bg-subtle-background dark:bg-background text-center">
                            <button className="text-xs font-semibold text-kurchi-gold-600 hover:text-kurchi-gold-700">View all notifications</button>
                        </div>
                    </div>
                )}
             </div>
             ...
             {currentUser && (
                <div className="hidden md:flex items-center space-x-3 px-4 py-2 rounded-xl bg-subtle-background dark:bg-background border border-border/50 dark:border-border">
                    ...
                    <div className="text-left">
                        <p className="text-sm font-bold text-kurchi-espresso-900 dark:text-white leading-tight">{currentUser.name}</p>

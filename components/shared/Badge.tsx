...
const statusClasses: Record<LeadPipelineStatus, { container: string, dot: string }> = {
  ...
  [LeadPipelineStatus.SITE_VISIT_RESCHEDULED]: { container: 'bg-purple-subtle-background text-purple-subtle-text', dot: 'bg-purple' },
  [LeadPipelineStatus.WAITING_FOR_DRAWING]: { container: 'bg-slate-subtle-background text-slate-subtle-text', dot: 'bg-text-secondary' },
  [LeadPipelineStatus.DRAWING_IN_PROGRESS]: { container: 'bg-primary-subtle-background text-primary-subtle-text', dot: 'bg-primary' },
  [LeadPipelineStatus.DRAWING_REVISIONS]: { container: 'bg-warning-subtle-background text-warning-subtle-text', dot: 'bg-warning' },
  [LeadPipelineStatus.WAITING_FOR_QUOTATION]: { container: 'bg-slate-subtle-background text-slate-subtle-text', dot: 'bg-text-secondary' },
  ...
  [LeadPipelineStatus.IN_SOURCING]: { container: 'bg-purple-subtle-background text-purple-subtle-text', dot: 'bg-purple' },

...
export const UserGroupIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.742-.586 1.5 1.5 0 0 0 .82-1.343V14.25a1.5 1.5 0 0 0-1.5-1.5h-1.5m-6 0h-1.5a1.5 1.5 0 0 0-1.5 1.5v2.54a1.5 1.5 0 0 0 .82 1.343A9.094 9.094 0 0 0 12 18.72m-6 0A9.094 9.094 0 0 1 2.258 18.134a1.5 1.5 0 0 1 .82-1.343V14.25a1.5 1.5 0 0 1 1.5-1.5h1.5m-6 0h-1.5a1.5 1.5 0 0 0-1.5 1.5v2.54a1.5 1.5 0 0 0 .82 1.343A9.094 9.094 0 0 0 6 18.72m6-11.118a3.75 3.75 0 1 0 7.5 0 3.75 3.75 0 0 0-7.5 0Zm-6 0a3.75 3.75 0 1 0 7.5 0 3.75 3.75 0 0 0-7.5 0Zm-6 0a3.75 3.75 0 1 0 7.5 0 3.75 3.75 0 0 0-7.5 0Z" />
    </svg>
);
...
export const TruckIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V14.25m-17.25 4.5v-1.875a3.375 3.375 0 0 1 3.375-3.375h9.75a3.375 3.375 0 0 1 3.375 3.375v1.875M3.375 14.25h17.25M12 14.25v-6.375m0 6.375a3.375 3.375 0 0 1-3.375-3.375V1.5" /></svg>
);

export const WrenchScrewdriverIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.878-5.878m0 0L21 5.625A2.652 2.652 0 0 0 17.25 3L11.42 8.828m0 0-3.182 3.182a4.5 4.5 0 0 0-6.364 6.364l7.927-7.927a4.5 4.5 0 0 1 6.364-6.364l-3.182 3.182Z" /></svg>
);

export const CreditCardIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3.375m-3.375 0h16.5m0 0h-16.5m16.5 0v2.25A2.25 2.25 0 0 1 18.75 21H5.25A2.25 2.25 0 0 1 3 18.75V6.75A2.25 2.25 0 0 1 5.25 4.5h13.5A2.25 2.25 0 0 1 21 6.75v1.5" /></svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 0 1-1.59 0l-3.72-3.72a2.36 2.36 0 0 1-1.98-2.193v-4.286c0-.97.616-1.813 1.5-2.097m0 0A7.496 7.496 0 0 0 12 7.5a7.496 7.496 0 0 0-3.75 1.011m0 0a7.5 7.5 0 0 0-1.12 4.243m1.12-4.243a7.5 7.5 0 0 1 2.248-3.132M3 10.5a5.25 5.25 0 0 1 5.25-5.25m0 0a5.25 5.25 0 0 1 5.25 5.25m-10.5 0a5.25 5.25 0 0 1 5.25-5.25m0 0a5.25 5.25 0 0 0-5.25 5.25m-5.25 0a5.25 5.25 0 0 1 5.25-5.25" /></svg>
);
...
export const UsersIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-2.253 9.597 9.597 0 0 0-1.655-1.438L18.75 15.75l-1.732-3.363a1.125 1.125 0 0 0-2.062 0L13.25 15.75l-1.732 3.363Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M6 19.128a9.38 9.38 0 0 1 2.625.372 9.337 9.337 0 0 1 4.121-2.253 9.597 9.597 0 0 1-1.655-1.438L9.75 15.75l-1.732-3.363a1.125 1.125 0 0 1-2.062 0L4.25 15.75l-1.732 3.363a9.337 9.337 0 0 1 4.121 2.253Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.337 9.337 0 0 0 4.121-2.253 9.597 9.597 0 0 0-1.655-1.438L12.75 15.75l-1.732-3.363a1.125 1.125 0 0 0-2.062 0L7.25 15.75l-1.732 3.363a9.337 9.337 0 0 0 4.121 2.253Z" /></svg>
);

export const CogIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M19.9999 12.0001C19.9999 13.5204 19.5312 14.9451 18.723 16.1432L18.7222 16.1449C18.6384 16.2731 18.5283 16.3831 18.3999 16.4669L17.3833 17.0769C17.3483 17.0954 17.3125 17.1125 17.2758 17.1283C15.831 17.8427 14.0433 18.1633 12.2475 17.9897L12.0009 17.9659L11.7543 17.9897C9.95851 18.1633 8.17083 17.8427 6.72596 17.1283C6.68926 17.1125 6.65345 17.0954 6.61849 17.0769L5.60192 16.4669C5.47348 16.3831 5.36341 16.2731 5.27961 16.1449L5.2788 16.1432C4.47101 14.9451 4 13.5204 4 12.0001C4 10.4798 4.47101 9.05505 5.2788 7.85697L5.27961 7.85526C5.36341 7.72706 5.47348 7.617 5.60192 7.53322L6.61849 6.92322C6.65345 6.90474 6.68926 6.88763 6.72596 6.87185C8.17083 6.15743 9.95851 5.83685 11.7543 6.01047L12.0009 6.03426L12.2475 6.01047C14.0433 5.83685 15.831 6.15743 17.2758 6.87185C17.3125 6.88763 17.3483 6.90474 17.3833 6.92322L18.3999 7.53322C18.5283 7.617 18.6384 7.72706 18.7222 7.85526L18.723 7.85697C19.5312 9.05505 19.9999 10.4798 19.9999 12.0001ZM21.9493 12.0001C21.9493 9.92135 21.2428 7.97335 20.0152 6.42335L19.9823 6.3813C19.8656 6.22554 19.7088 6.1041 19.5283 6.03322L18.5118 5.42322C18.4943 5.41703 18.4766 5.41031 18.4586 5.40307C16.6295 4.54911 14.4988 4.21851 12.3952 4.47644L12.0009 4.52224L11.6066 4.47644C9.50293 4.21851 7.37227 4.54911 5.54324 5.40307C5.52522 5.41031 5.50754 5.41703 5.49004 5.42322L4.47347 6.03322C4.29293 6.1041 4.13612 6.22554 4.01944 6.3813L3.98657 6.42335C2.75894 7.97335 2.05249 9.92135 2.05249 12.0001C2.05249 14.0788 2.75894 16.0268 3.98657 17.5768L4.01944 17.6188C4.13612 17.7746 4.29293 17.896 4.47347 17.9669L5.49004 18.5769C5.50754 18.5831 5.52522 18.5898 5.54324 18.5971C7.37227 19.451 9.50293 19.7816 11.6066 19.5237L12.0009 19.4779L12.3952 19.5237C14.4988 19.7816 16.6295 19.451 18.4586 18.5971C18.4766 18.5898 18.4943 18.5831 18.5118 18.5769L19.5283 17.9669C19.7088 17.896 19.8656 17.7746 19.9823 17.6188L20.0152 17.5768C21.2428 16.0268 21.9493 14.0788 21.9493 12.0001Z" />
...
export const ArrowUpIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 10.5 12 3m0 0 7.5 7.5M12 3v18" /></svg>
);

export const ArrowDownIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 13.5 12 21m0 0-7.5-7.5M12 21V3" /></svg>
);
...
export const ShieldCheckIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.317-.266-2.59-.748-3.752A11.959 11.959 0 0118 6c0-1.714-.395-3.32-1.102-4.774" />
    </svg>
);

export const ShieldExclamationIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m0 4.5h.01M21.75 12a9.75 9.75 0 1 1-19.5 0 9.75 9.75 0 0 1 19.5 0Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.75c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.317-.266-2.59-.748-3.752A11.959 11.959 0 0 1 18 6c-1.714 0-3.32-.395-4.774-1.102L12 3.375Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m0 4.5h.01" />
    </svg>
);
...
export const BuildingStorefrontIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0 1 14.25 12h.01a.75.75 0 0 1 .75.75v7.5m-3.75-7.5A.75.75 0 0 0 9.75 12h.01a.75.75 0 0 0 .75.75v7.5m-3.75 0v-7.5A.75.75 0 0 1 6.75 12h.01a.75.75 0 0 1 .75.75v7.5m6-15h.008v.008H12v-.008Zm-3.75 0h.008v.008H8.25v-.008Zm0 3h.008v.008H8.25v-.008Zm0 3h.008v.008H8.25v-.008Zm3-6h.008v.008H11.25v-.008Zm0 3h.008v.008H11.25v-.008Zm0 3h.008v.008H11.25v-.008Zm3-6h.008v.008H14.25v-.008Zm0 3h.008v.008H14.25v-.008Zm0 3h.008v.008H14.25v-.008Zm3-6h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Zm0 3h.008v.008H17.25v-.008Zm3-6h.008v.008H20.25v-.008Zm0 3h.008v.008H20.25v-.008Zm0 3h.008v.008H20.25v-.008Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 9.75a.75.75 0 0 1 .75-.75h16.5a.75.75 0 0 1 .75.75v11.25a.75.75 0 0 1-.75.75H3.75a.75.75 0 0 1-.75-.75V9.75Z" />
    </svg>
);

export const PresentationChartLineIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h12A2.25 2.25 0 0 0 20.25 14.25V3M3.75 14.25v-1.5a3.375 3.375 0 0 1 3.375-3.375h9.75a3.375 3.375 0 0 1 3.375 3.375v1.5M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25v-6.75A2.25 2.25 0 0 0 19.5 8.25h-15A2.25 2.25 0 0 0 2.25 10.5v6.75A2.25 2.25 0 0 0 4.5 19.5Z" />
    </svg>
);
...
export const RectangleGroupIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 7.125A2.25 2.25 0 0 1 4.5 4.875h15A2.25 2.25 0 0 1 21.75 7.125v1.562a2.25 2.25 0 0 1-2.25 2.25H4.5A2.25 2.25 0 0 1 2.25 8.687V7.125ZM2.25 15.125A2.25 2.25 0 0 1 4.5 12.875h15A2.25 2.25 0 0 1 21.75 15.125v1.562a2.25 2.25 0 0 1-2.25 2.25H4.5A2.25 2.25 0 0 1 2.25 16.687v-1.562Z" />
    </svg>
);

export const RectangleStackIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75 2.25 12l4.179 2.25m0-4.5 5.571 3 5.571-3m-11.142 0L12 15.25l5.571-3M6.429 9.75l5.571 3m0 0l5.571-3m0 0-5.571 3m0 0-5.571-3m11.142 0-5.571 3M4.5 12.75v-1.5a3.375 3.375 0 0 1 3.375-3.375h9.75a3.375 3.375 0 0 1 3.375 3.375v1.5" />
    </svg>
);
...
export const CalculatorIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008Zm0 3h.008v.008H8.25v-.008Zm0 3h.008v.008H8.25v-.008Zm3-6h.008v.008H11.25v-.008Zm0 3h.008v.008H11.25v-.008Zm0 3h.008v.008H11.25v-.008Zm3-6h.008v.008H14.25v-.008Zm0 3h.008v.008H14.25v-.008Zm0 3h.008v.008H14.25v-.008M12 6.75h2.25M12 9.75h2.25M12 12.75h2.25M12 15.75h2.25M15.75 6.75v.008H15.75V6.75Zm0 3v.008H15.75V9.75Zm0 3v.008H15.75v-3Zm0 3v.008H15.75v-3Zm-12-3.375c0-1.626 1.374-2.96 3.038-2.96h6.424c1.664 0 3.038 1.334 3.038 2.96v6.423c0 1.626-1.374 2.96-3.038 2.96H6.788c-1.664 0-3.038-1.334-3.038-2.96V9.375Z" />
    </svg>
);
...
export const ChatBubbleOvalLeftEllipsisIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.753 9.753 0 0 1-4.597-1.106c-.344-.197-.525-.56-.525-.944V14.25a1.868 1.868 0 0 1 .372-1.044m5.803-3.75a4.5 4.5 0 0 0-4.5-4.5C6.536 4.901 3 8.456 3 12.977a8.97 8.97 0 0 0 2.481 5.923A8.97 8.97 0 0 0 12 21.023A8.97 8.97 0 0 0 21 12.053Z" />
    </svg>
);
...
export const TrophyIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.75v5.25m-1.5-5.25v5.25m-3.75-5.25v5.25m6-5.25v5.25M3 18.75h18a.75.75 0 0 0 .75-.75V11.25a.75.75 0 0 0-.75-.75h-3.375c0-4.142-3.358-7.5-7.5-7.5S4.125 6.358 4.125 10.5H.75a.75.75 0 0 0-.75.75v6.75c0 .414.336.75.75.75h2.25" />
...
export const LightBulbIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-4.5 4.5 4.5 0 11-9 0 6.01 6.01 0 001.5 4.5m0 0v5.25m0 0h6m-6 0a9 9 0 1118 0 9 9 0 01-18 0z" />
    </svg>
);

        ...
        <div className="lg:w-1/2 relative group">
            <FadeInSection className="h-full w-full">
                ...
                <div className="relative z-10 overflow-hidden h-full shadow-xl">
                    <img src={image} alt={title} className="w-full h-[500px] object-cover filter grayscale hover:grayscale-0 transition-all duration-1000 ease-luxury hover:scale-105" />
                </div>
            </FadeInSection>
        </div>
